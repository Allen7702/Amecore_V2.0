...
<div class="container-fluid  py-5 bg-header" style="margin-bottom: 90px;background:url({{asset('website/img/' . $firstSection->title_image)}}) center center no-repeat;height:35rem;">
    <div class="row py-5 ">
        <div class="col-12 pt-lg-5 mt-lg-5 text-center ">
            <h1 class="display-4 text-white animated zoomIn nunito">{{$firstSection->title}}</h1>
     ...
     <!-- Contact Start -->
     <div class="container-fluid py-5 wow fadeInUp" style="max-width:90%" data-wow-delay="0.1s" >
            ...
            <div class="flex-container mb-5 ps ml-lg-5" >
               ...
               <div class="">
                    <div class="d-flex align-items-center wow fadeIn" data-wow-delay="0.1s">
                        ...
                        <div class="ps-4 mb-2 ml-4 ">
                            <h5 class="mb-2">{{$contact->icon_name}}</h5>
                            <h4 class="text-primary mb-0">{{$contact->description}}</h4>
                        </div>
                    </div>
                </div>
                @endforeach
                ...
                <div class="">
                    <div class="d-flex align-items-center wow fadeIn" data-wow-delay="0.8s">
                        ...
                        <div class="ps-4 ml-4">
                            ...
                            <h4 class="text-primary mb-0">Mwai Kibaki Road,Mikocheni</h4>
                        </div>
                    </div>
                </div> --}}
            </div>
                    ...
                    <form>
                        <div class="row g-3">
                            <div class="col-md-6 mb-4">
                                <input type="text" class="form-control border-1 rounded bg-light px-4" placeholder="Your Name" style="height: 55px;">
                            </div>
                            <div class="col-md-6 mb-4">
                                <input type="email" class="form-control border-1 bg-light px-4" placeholder="Your Email" style="height: 55px;">
                            </div>
                            <div class="col-12 mb-4">
                                <input type="text" class="form-control border-1 bg-light px-4" placeholder="Subject" style="height: 55px;">
                            </div>
                            <div class="col-12 mb-4">
                                <textarea class="form-control border-1 bg-light px-4 py-3" rows="4" placeholder="Message"></textarea>
                            </div>
                            <div class="col-12 mb-4">
